    ...
    return (
        <div>
            ...
            <section className="home-section-header">
                <div className="home-section-header-left">
                    <div>
                        ...
                        <p>
                            Saya Faqih Pratama Muhti <br/>Dari Universitas Buana Perjuangan Karawang
                        </p>
                    </div>
                </div>
                <div className="home-section-header-right">
                    <img className="avatar-banner" src="/images/me.jpg" alt="Avatar about" />
                </div>
            </section>
            <section className="home-section-second">
                ...
                <p>
                    Faqih Pratama Muhti<br/>Universitas Buana Perjuangan Karawang.
                </p>
            </section>
